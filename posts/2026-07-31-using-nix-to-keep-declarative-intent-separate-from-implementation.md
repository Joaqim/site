...
The intent of this blog post is not to explain [Nix](https://nixos.org), [NixOS](https://nixos.org) or [Nixpkgs](https://nixos.org/manual/nixpkgs/stable/), but rather to show how `nix` allows for keeping actual code implementation separate from actual intent of deployment.
